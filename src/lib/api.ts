// Secure API Client for Rafid Platform Backend
// Handles real backend API calls with robust local storage-based fallback for the preview environment

import { PaginatedResponse } from '../hooks/usePaginatedQuery';
