...
export default function AdminPanel({ language, onBack, showToast }: AdminPanelProps) {
  ...
  const handleRunScraper = async () => {
    showToast('Scraper/automation removed from MVP. Use manual approved opportunities instead.', 'info');
  };
  ...
  const getTranslatedLabel = (key: string) => {
    const translations: Record<string, Record<Language, string>> = {
      ...
      panelTitle: { en: 'Admin Content Control', ar: 'Ù„ÙˆØ­Ø© Ø§Ù„ØªØ­ÙƒÙ… ÙˆØ§Ù„Ø£ØªÙ…ØªØ©', ku: 'Ú©Û†Ù†ØªØ±Û†ÚµÛŒ Ø¦Û†ØªÛ†Ù…Ø§ØªÛŒÚ©ÛŒ' },
      ...
      runScraper: { en: 'Manual Opportunities Only', ar: 'ØªØ´ØºÙŠÙ„ Ø²Ø§Ø­Ù Ø§Ù„ÙØ±Øµ Ø§Ù„Ø¢Ù†', ku: 'Ø¦ÛŽØ³ØªØ§ Ø²Ø§Ù†ÛŒØ§Ø±ÛŒ Ú©Û†Ø¨Ú©Û•Ø±Û•ÙˆÛ•' },
